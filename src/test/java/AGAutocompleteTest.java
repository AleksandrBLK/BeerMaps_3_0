...
public class AGAutocompleteTest extends AGMapTest {
    /**
     * TestRouter_2 Autocomplete for each prefix, comparing the sets of outputs against each other.
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestRouter_2 location search by full search string, comparing the output lists against each other
